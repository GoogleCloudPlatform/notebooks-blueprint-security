...
# Name for privileged service account used by terraform
# This will be automatically created
export SA_NAME=""

# Provide the group name that is allowed to access trusted data.  The Notebook service account will be added to this group
export GRP_TRUSTED_DATA_SCIENTISTS=""
...
echo "Group id for trusted data scientists: ${GRP_TRUSTED_DATA_SCIENTISTS:?}"
echo "==================================================="
echo ""
